...
function AboutMe() {
  return (
    <div className="hero min-h-screen bg-base-200 justify-start align items-start">
    <div className="div"> 
    <h1 className="fill-transparent text-6xl font-bold mb-4 bg-base-200">
      ...
      <p className="h-full w-1/2">
        Hello! My name is Paul and I enjoy creating things that live on the
